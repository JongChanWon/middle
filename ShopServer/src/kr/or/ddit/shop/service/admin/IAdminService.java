...
public interface IAdminService extends Remote{
	...
	// 공지사항 CRUD
		public List<AdmwrtVO> getCommonNotice() throws RemoteException; // 일반회원 공지사항 조회
		public List<AdmwrtVO> getCompanyNotice() throws RemoteException; // 업체회원 공지사항 조회
		public int insertNotice(AdmwrtVO av) throws RemoteException; // 공지사항 추가
		public int deleteNotice(AdmwrtVO av) throws RemoteException; // 공지사항 삭제
}
