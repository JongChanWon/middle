...
public class OrderTbVO implements Serializable{
	...
	public OrderTbVO(int orderListNum, int order_no, int mem_no, String order_date, int order_price,
			String order_status, String del_name, String del_phone, String del_addr1, String del_addr2, String del_zip,
			String del_msg) {
		super();
	...
	public String toString() {
		return "OrderTbVO [orderListNum=" + orderListNum + ", order_no=" + order_no + ", mem_no=" + mem_no
				+ ", order_date=" + order_date + ", order_price=" + order_price + ", order_status=" + order_status
				+ ", del_name=" + del_name + ", del_phone=" + del_phone + ", del_addr1=" + del_addr1 + ", del_addr2="
				+ del_addr2 + ", del_zip=" + del_zip + ", del_msg=" + del_msg + "]";
	}
